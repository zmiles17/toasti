...
-- gin and tonic
INSERT INTO recipedb.recipes (`id`,`name`,`instruction`,`createdAt`,`updatedAt`) VALUES (2,'Gin and Tonic','Stir over ice, garnish and serve',NOW(),NOW());
...
-- screwdriver
INSERT INTO recipedb.recipes (`id`,`name`,`instruction`,`createdAt`,`updatedAt`) VALUES (3,'Screwdriver','Stir over ice, garnish and serve',NOW(),NOW());
...
-- lit
INSERT INTO recipedb.recipes (`id`,`name`,`instruction`,`createdAt`,`updatedAt`) VALUES (4,'Long Island Iced Tea','Mix all contents in a highball glass and stir gently. Add dash of Coca-Cola for the coloring and garnish with lemon or lime twist',NOW(),NOW());
...
-- moscow mule
INSERT INTO recipedb.recipes (`id`,`name`,`instruction`,`createdAt`,`updatedAt`) VALUES (6,'Moscow Mule',' Combine vodka and ginger beer in a copper mug or highball glass filled with ice. Add lime juice. Stir gently and garnish with a lime slice.',NOW(),NOW());
...
-- gimlet
INSERT INTO recipedb.recipes (`id`,`name`,`instruction`,`createdAt`,`updatedAt`) VALUES (7,'Gimlet',' Mix and serve. Garnish with a slice of lime.',NOW(),NOW());
...
--french 
INSERT INTO recipedb.recipes (`id`,`name`,`instruction`,`createdAt`,`updatedAt`) VALUES (8,'French 75','Using zester or paring knife, slice peel from lemon in long, thin spiral. Reserve lemon for another use and set peel aside.
